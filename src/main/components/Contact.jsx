...
export const Contact = () => {
  return (
    <div className='mt-12 sm:mx-20'>
        <h3 className='text-white font-bold text-7xl'>Connect with me</h3>
        ...
        className='text-center font-bold text-white text-6xl mt-10 mb-5 '>Develop by Francisco Santos</motion.h3>
    </div>
  )
}
